function begin () {
    ...
    // for (var i = 0; i < elements.length; i++) {
        ...
        // if (elements[i].innerHTML.indexOf("facebook-unfriender-one-click") == -1) {
            ...
            // elem.innerHTML = elem.innerHTML + "<div class='facebook-unfriender-one-click' onclick='" + itsalive + "' style='color: red !important; float: right; margin-top: 1.5px; font-size: 17px; cursor: pointer;'><b>X</b></div>";
        // }
    // }
