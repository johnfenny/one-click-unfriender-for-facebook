...
function begin() {
    ...
    for (var i = 0; i < elements.length; i++) {
        ...
        if (elements[i].innerHTML.indexOf("facebook-unfriender-one-click") == -1) {
            elements[i].innerHTML = elements[i].innerHTML + "<div class='facebook-unfriender-one-click' onclick='" + unfriend + "' style='color: red !important; float: right; margin-top: 5.5px; cursor: pointer;'><b>X</b></div>";
        }
    }
}
