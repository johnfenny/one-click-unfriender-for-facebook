...
function begin() {
    ...
    for (var i = 0; i < elements.length; i++) {
        elements[i].innerHTML = elements[i].innerHTML + " <div style='color: red !important; float: right; margin-top: 5.5px;'><b>X</b></div>";
        // elements[i].style.display = "none";
        console.log(elements[i].parentElement.innerHTML.split("/ajax/messaging/composer.php?ids%5B0%5D=")[1].split("&")[0]);
    }
